...
const DairyBreadEggs = () => {
  ...
  // 🔹 Load Dairy, Bread & Eggs products
  const loadData = async () => {
    try {
      const api = `${BackendURL}/blinkitproduct/dairy`;
      const res = await axios.get(api);
      setMydata(res.data);
    } catch (error) {
      console.log("Dairy API Error 👉", error);
    }
  };
  ...
  return (
    <div  >
      <h2 className="category-title">Dairy, Bread & Eggs</h2>
